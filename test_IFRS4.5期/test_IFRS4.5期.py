...
def select_mapping():
        return {
            'tags_contexts': {
                ...
                'NetSalesYTD': (['jpigp_cor:NetSalesIFRS', 'jpigp_cor:RevenueIFRS'], "CurrentYTDDuration", True, 'millions'),
                #売上原価
                ...
                'ProfitLossBeforeYTD': (['jpigp_cor:ProfitLossBeforeTaxIFRS'], "CurrentYTDDuration", True, 'millions'),
                #純利益（当期利益）
                ...
                'ProfitLossYTD': (['jpigp_cor:ProfitLossIFRS'], "CurrentYTDDuration", True, 'millions'),
                #発行株数
                ...
                'TotalAssetsQuarter': (['jpigp_cor:AssetsIFRS'], "CurrentQuarterInstant", True, 'millions'),
                #資本
                ...
                'EquityAttributableQuarter': (['jpigp_cor:EquityAttributableToOwnersOfParentIFRS'], "CurrentQuarterInstant", True, 'millions'),
                #営業CF
                ...
                'OperatingYTD': (['jpigp_cor:NetCashProvidedByUsedInOperatingActivitiesIFRS'], "CurrentYTDDuration", True, 'millions'),
                #投資CF
                ...
                'InvestingYTD': (['jpigp_cor:NetCashProvidedByUsedInInvestingActivitiesIFRS'], "CurrentYTDDuration", True, 'millions'),
                #財務CF
                ...
                'FinancingYTD': (['jpigp_cor:NetCashProvidedByUsedInFinancingActivitiesIFRS'], "CurrentYTDDuration", True, 'millions'),
                #FCF
                ...
                'CashAndCashQuarter': (['jpigp_cor:CashAndCashEquivalentsIFRS'], "CurrentQuarterInstant", True, 'millions'),
                #証券コード
            ...
            'cell_map_file2': {
                ...
                #資本
                'EquityAttributablePrior3': 'D17', 'EquityAttributablePrior2': 'G17',
                'EquityAttributablePrior1': 'J17', 'EquityAttributableCurrent': 'M17',
                #営業CF
...
loops = [
    ...
    },
    {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート3.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート4.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート5.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート6.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート7.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート8.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート9.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート10.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート11.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート12.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート13.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート14.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート15.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート16.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート17.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート18.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート19.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート20.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート21.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート22.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート23.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート24.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート25.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート26.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート27.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート28.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート29.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート30.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート31.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート32.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート33.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート34.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート35.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート36.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート37.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート38.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート39.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート40.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート41.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート42.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート43.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート44.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート45.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート46.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート47.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート48.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート49.xlsx'
    },
    {
        'xbrl_file_paths': {
        ...
        'excel_file_path': r'C:\Users\Owner\OneDrive\PC\EDINET\決算分析シート\決算分析シート50.xlsx'
    }
]
