...
class MetricLabelsTest(unittest.TestCase):
    def test_metric_base_to_display_name_returns_japanese_label(self) -> None:
        ...
        self.assertEqual(metric_base_to_display_name("BPSGrowthRate10Year"), "\u0042\u0050\u0053\u5897\u52a0\u7387(10\u5e74)")
        self.assertEqual(metric_base_to_display_name("MarketCapitalization"), "\u6642\u4fa1\u7dcf\u984d")
        self.assertEqual(metric_base_to_display_name("StockPrice"), "\u682a\u4fa1")
        self.assertEqual(metric_base_to_display_name("StockPriceGrowthRate"), "\u682a\u4fa1\u4e0a\u6607\u7387")
        self.assertEqual(metric_base_to_display_name("StockPriceGrowthRate5Year"), "\u682a\u4fa1\u4e0a\u6607\u7387(\uff15\u5e74)")
        self.assertEqual(metric_base_to_display_name("StockPriceGrowthRate10Year"), "\u682a\u4fa1\u4e0a\u6607\u7387(10\u5e74)")
        self.assertEqual(metric_base_to_display_name("PBR"), "PBR")
        self.assertEqual(metric_base_to_display_name("PER"), "PER")
        self.assertEqual(metric_base_to_display_name("PCFR"), "PCFR")
