    ...
    if has_non_consolidated_member:
        return {
            ...
            #個別決算の場合
                ...
                #純利益
                'NetIncomePrior': ('jpcrp_cor:NetIncomeLossSummaryOfBusinessResults', "Prior1YearDuration_NonConsolidatedMember", True, 'millions'),
                'NetIncomeCurrent': ('jpcrp_cor:NetIncomeLossSummaryOfBusinessResults', "CurrentYearDuration_NonConsolidatedMember", True, 'millions'),
                #発行株数
                ...
                #資産
                'TotalAssetsPrior4': ('jpcrp_cor:TotalAssetsSummaryOfBusinessResults', "Prior4YearInstant_NonConsolidatedMember", True, 'millions'),
                ...
                #資本
                'NetAssetsPrior4': ('jpcrp_cor:NetAssetsSummaryOfBusinessResults', "Prior4YearInstant_NonConsolidatedMember", True, 'millions'),
                ...
                #FCF
                'CashAndCashEquivalentsPrior': ('jpcrp_cor:CashAndCashEquivalentsSummaryOfBusinessResults', "Prior1YearInstant_NonConsolidatedMember", True, 'millions'),
                'CashAndCashEquivalentsCurrent': ('jpcrp_cor:CashAndCashEquivalentsSummaryOfBusinessResults', "CurrentYearInstant_NonConsolidatedMember", True, 'millions'),
                #証券コード
            ...
            'cell_map_file2': {
                ...
                #純利益
                'NetIncomePrior': 'J11', 'NetIncomeCurrent': 'M11',
                #営業CF
            ...
            'cell_map_file3': {
                ...
                #販管費
                'SellingExpensesCurrent': 'P8',
                #営業利益
                'OperatingIncomeCurrent': 'P9',
                #経常利益
                'OrdinaryIncomeCurrent': ['P31', 'P37'],
                #純利益
                'NetIncomeCurrent': ['P32', 'P38'],
                #発行株数
                ...
                #資本
                'NetAssetsPrior4': 'D17', 'NetAssetsPrior3': 'G17',
                'NetAssetsPrior2': 'J17', 'NetAssetsPrior1': 'M17',
                'NetAssetsCurrent': 'P44',
                #営業CF
                'OperatingCashCurrent': 'O48',
                #投資CF
                'InvestmentCashCurrent': 'P48',
                #財務CF
                'FinancingCashCurrent': 'Q48',
                #FCF
                'CashAndCashEquivalentsCurrent': 'P49',    
                #証券コード
                'SecurityCodeDEI': 'K2',
                #会社名
        ...
        return {
            ...
            #連結決算の場合
                ...
                'TotalNumberCurrent': ('jpcrp_cor:TotalNumberOfIssuedSharesSummaryOfBusinessResults', "CurrentYearInstant_NonConsolidatedMember", True, 'thousands'),
                #資産
                'TotalAssetsPrior4': ('jpcrp_cor:TotalAssetsSummaryOfBusinessResults', "Prior4YearInstant", True, 'millions'),
                ...
                #資本
                'NetAssetsPrior4': ('jpcrp_cor:NetAssetsSummaryOfBusinessResults', "Prior4YearInstant", True, 'millions'),
