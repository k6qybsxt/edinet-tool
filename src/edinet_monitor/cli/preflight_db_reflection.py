...
def main() -> None:
    ...
    print(f"matched_pending_count={result.summary.get('matched_pending_count', len(result.pending_items))}")
    print(f"db_size_gb={result.summary.get('db_size_gb', '')}")
    print(f"heavy_db_size_warning_threshold_gb={result.summary.get('heavy_db_size_warning_threshold_gb', '')}")
    print(f"long_date_range_warning_days={result.summary.get('long_date_range_warning_days', '')}")
